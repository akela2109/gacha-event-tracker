...
// Обновлено: 2026-07-14 (данные верифицированы, изменений нет)
window.SNAPSHOT_NTE = {
  ...
  items: [
    ...
    { type: "event", title: "Resolve Perks", subtitle: "Бонусные косметические награды за 50/120/200 ролов на баннере Shinku: глайдер Overcast Canopy, ливрея Hidden Dragon, скин Student of Terrasea", startsAt: "2026-07-08T00:00:00Z", endsAt: "2026-07-29T00:00:00Z" },
    { type: "event", title: "Mews Flash", subtitle: "Скретч-карты: собирай карточки за активности и обменивай на призы", startsAt: "2026-07-08T00:00:00Z", endsAt: "2026-08-18T00:00:00Z" },
    ...
    { type: "event", title: "Warren Lucky Flip", subtitle: "Лотерея переворачивания карточек в регионе Warren: испытывай удачу за активности и обменивай призы", startsAt: "2026-08-05T00:00:00Z", endsAt: "2026-08-19T00:00:00Z" },
    { type: "event", title: "Fons Rush", subtitle: "Ускоренный фарм Fons: бустовый ивент для увеличения дохода ресурсов", startsAt: "2026-08-10T00:00:00Z", endsAt: "2026-08-17T00:00:00Z" },
